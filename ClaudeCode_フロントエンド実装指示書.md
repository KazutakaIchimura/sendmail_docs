...
> **2026-06-22追記**: 本ファイルは初回スキャフォールド時（プロジェクト開始時）の指示書であり、内容は当時の前提のまま更新していない。実装が進んだ現在、DADSコンポーネントの実際のprops名・バージョン、APIエンドポイントの詳細、画面仕様の最新版は以下を参照すること。
> - DADSコンポーネントの実際の使い方: [CLAUDE.md](./CLAUDE.md)、[郵便物送付管理システム_フロントエンド設計書.md](./郵便物送付管理システム_フロントエンド設計書.md) セクション7
> - 画面仕様・最新の挙動: [郵便物送付管理システム_フロントエンド設計書.md](./郵便物送付管理システム_フロントエンド設計書.md) セクション3
> - APIエンドポイント: [郵便物送付管理システム_バックエンド設計書.md](./郵便物送付管理システム_バックエンド設計書.md) セクション9
